...
=======
#define DEFAULT_NOMINAL_FILAMENT_DIA 2.75
>>>>>>> Stashed changes
...
#define DUMMY_THERMISTOR_999_VALUE 215
 ...
 */
 //***Tu zmainy
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 160, 400, 12 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 35 , 35, 3, 100 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 60, 60, 3, 100 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 100, 100, 150, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27, 3, 0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.6  // (mm) Default layer height for G26.
    ...
    #define G26_XY_FEEDRATE_TRAVEL 25    // (mm/s) Feedrate for G26 XY travel moves.
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 80, 80, 80, 80 } // (mm) Left, Front, Right, Back insets
...
#define HOMING_FEEDRATE_MM_M { (30*60), (30*60), (2*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 25   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
